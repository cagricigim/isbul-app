...
export const TURKEY_CITIES: City[] = [
  ...
  {
    name: "Çankırı",
    districts: ["Atkaracalar", "Bayramören", "Çerkeş", "Eldivan", "Hanköy", "Ilgaz", "Kızılırmak", "Korgun", "Kurşunlu", "Merkez", "Orta", "Şabanözü", "Yapraklı"],
  },
  {
    name: "Çorum",
  ...
  {
    name: "Sivas",
    districts: ["Akıncılar", "Altınyayla", "Divriği", "Doğanşar", "Gemerek", "Gölova", "Hafik", "İmranlı", "Kangal", "Koyulhisar", "Merkez", "Suşehri", "Şarkışla", "Ulaş", "Yıldızeli", "Zara"],
  },
  {
    name: "Tekirdağ",
  ...
  {
    name: "Tunceli",
    districts: ["Çemişgezek", "Hozat", "Mazgirt", "Merkez", "Nazimiye", "Ovacık", "Pertek", "Pülümür"],
  },
  {
    name: "Uşak",
